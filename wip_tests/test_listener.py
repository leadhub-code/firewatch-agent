...
from firewatch_agent.util import get_free_tcp_port
...
def test_listener():
    ...
    with multiprocessing.Manager() as manager:
        ...
        try:
            ...
            listener = ReportWarningListener(base_url + '/report')
            ...
            assert list(received) == [('report',
              {'firewatch_report': {'events': [{'chunk': 'cheese\n',
